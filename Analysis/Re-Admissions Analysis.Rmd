...
print(paste("Mis-Class error is :",misClassError(targetVar, predictions, threshold = optCutOff)))
...
```{r, message=FALSE, warning=FALSE}
predicteds = ifelse(predictions > optCutOff, 1, 0)
ks_plot(actuals=targetVar, predictedScores=predicteds)
```
